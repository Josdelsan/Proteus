...
class AssetEdit(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Initialize widgets
        self.text_edit: QLineEdit = None
        self.browse_button: QPushButton = None
        self.info_button: QPushButton = None
    ...
    def create_input(self) -> None:
        ...
        # Browse button
        browse_icon_path: Path = Config().get_icon(APP_ICON_TYPE, "browse_icon")
