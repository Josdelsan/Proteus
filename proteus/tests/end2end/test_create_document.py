...
def test_create_document(qtbot, app):
    """
    ...
    load_project(main_window=main_window, project_name="empty_project")
    ...
    qtbot.mouseClick(add_document_button, Qt.MouseButton.LeftButton)
