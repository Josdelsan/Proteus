...
<!-- ======================================================== -->
<!-- File    : PROTEUS_business_actor.xsl                     -->
<!-- Content : PROTEUS XSLT for subjects at US - businessactor-->
...
>
    ...
    <!-- ============================================= -->
    <!-- proteus:business-actor template                     -->
    <!-- ============================================= -->

    <xsl:template match="object[@classes='madeja business-actor']">
        ...
        <div id="{@id}"  data-proteus-id="{@id}">
            <table class="madeja_object remus_table">
                ...
                <xsl:call-template name="generate_software_requirement_expanded_header">
                    ...
                    <xsl:with-param name="class"   select="'madejaBusinessActor'"/>
                </xsl:call-template>
