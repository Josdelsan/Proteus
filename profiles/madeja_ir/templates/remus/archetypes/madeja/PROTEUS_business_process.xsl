...
<!-- Content : PROTEUS XSLT for subjects at US businessprocess-->
...
>
    ...
    <!-- ============================================= -->
    <!-- proteus:business-process template                     -->
    <!-- ============================================= -->

    <xsl:template match="object[@classes='madeja business-process']">
        ...
        <div id="{@id}"  data-proteus-id="{@id}">
            <table class="madeja_object remus_table">
                ...
                <xsl:call-template name="generate_software_requirement_expanded_header">
                    ...
                    <xsl:with-param name="class"   select="'madejaBusinessProcess'"/>
                </xsl:call-template>
