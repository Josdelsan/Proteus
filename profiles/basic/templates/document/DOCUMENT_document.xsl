    ...
    <xsl:template match="object[@classes=':Proteus-document']">
        ...
        <html>
            <head>
                ...
                <!-- Remus stylesheets -->
                <link rel="stylesheet" href="templates:///document/resources/css/remus.css"/>

                <!-- Custom stylesheets -->
                <link rel="stylesheet" href="templates:///document/resources/css/codehilite.css"/>
            ...
            <body>
                ...
                <script src="templates:///document/resources/javascript/proteus.js"></script> 
