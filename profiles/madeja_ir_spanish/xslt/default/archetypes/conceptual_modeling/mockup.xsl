...
<!-- ======================================================== -->
<!-- File    : mockup.xsl                                     -->
<!-- Content : PROTEUS default XSLT for mockup                -->
...
>
    ...
    <xsl:template match="object[contains(@classes,'mockup')]">
        ...
        <xsl:variable name="mandatory_properties">,description,diagram,</xsl:variable>

        <div id="{@id}" data-proteus-id="{@id}">
            <table class="mockup remus_table">
                <!-- Header -->
                <xsl:call-template name="generate_header">
                    <xsl:with-param name="label"   select="properties/*[@name=':Proteus-code']"/>
                    <xsl:with-param name="class"   select="'mockup'"/>
                </xsl:call-template>
